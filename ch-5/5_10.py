# Exercise 5-10. Checking Usernames: Do the following to create a program that
...
current_users = ["Ethan", "Ethakins", "Ethaleeny", "Ethaweenie", "Mr.Lee"]

new_users = ["Ethakins", "Ethaleeny", "Matthew", "Deanna", "Jim"]

current_users_l = [user.lower() for user in current_users]

for user in new_users:
    if user.lower() in current_users_l:
        print(f"Username {user} exists, you will need to enter a new username")
    else:
